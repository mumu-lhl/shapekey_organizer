...
_zh_fallback = {
    ...
    "Preset Editing Tools": "预设编辑工具",
    "Show Preset Editing Tools": "显示预设编辑工具",
    ...
    "Assign Selected from All List": "将所有列表选中项归类",
    "Assign checked shape keys from the All Shape Keys list to the active category without overwriting existing categories": "将“所有形态键”列表中选中的形态键归类到当前分类，不覆盖已有分类",
    "Assign the single selected row in All Shape Keys to the active category without overwriting existing categories": "将所有形态键列表中单选的形态键归类到当前分类，不覆盖已有分类",
    "Remove the single selected row in All Shape Keys from its current category": "移除所有形态键列表中单选形态键的现有分类",
    ...
    "Single Selected All Item:": "所有列表单选项:",
    "Range Anchor:": "范围锚点:",
    ...
    "Assign Single Selected Shape Key": "归类单选中的形态键",
    "Remove Single Selected Shape Key from Category": "移除单选中的形态键分类",
